  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "card": "0 0 0 1px rgb(0 0 0 / 0.04), 0 2px 4px rgb(0 0 0 / 0.06), 0 4px 12px rgb(0 0 0 / 0.06)",
        "card-hover": "0 0 0 1px rgb(0 0 0 / 0.06), 0 4px 8px rgb(0 0 0 / 0.1), 0 8px 20px rgb(0 0 0 / 0.08)",
        "notification": "0 4px 12px rgb(0 0 0 / 0.15), 0 0 0 1px rgb(0 0 0 / 0.05)",
        "priority-critical": "0 0 0 1px rgb(239 68 68 / 0.2), 0 2px 8px rgb(239 68 68 / 0.15)",
        "priority-high": "0 0 0 1px rgb(249 115 22 / 0.2), 0 2px 8px rgb(249 115 22 / 0.15)",
      ...
      backgroundImage: {
        ...
        "dot-pattern": "url(\"data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%239C92AC' fill-opacity='0.04' fill-rule='evenodd'%3E%3Ccircle cx='3' cy='3' r='1.5'/%3E%3C/g%3E%3C/svg%3E\")",
      },
